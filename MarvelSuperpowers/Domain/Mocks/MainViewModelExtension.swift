...
extension MainViewModel {
    ...
    func getFakeHerosForDesignAndtesting(){
        ...
        let hero1 = HeroeData(id: 1011334, name: "3-D Man", description: "", thumbnail: thumbnail1, series: MarvelItem(available: 2, collectionURI: "", items: [ApiItem(resourceURI: "http://i.annihil.us/u/prod/marvel/i/mg/c/e0/535fecbbb9784", name: "Serie 1")], returned: 2))
