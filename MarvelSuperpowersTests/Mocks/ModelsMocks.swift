...
// MARK: - Models for Mock -
class ModelsMocks {
    let serie = SingleSerieData(id: 123, 
                                title: "Los vengadores",
                                description: "Qué guay",
                                thumbnail: Thumbnail(path: "http://i.annihil.us/u/prod/marvel/i/mg/c/e0/535fecbbb9784",
                                                     extension2: "jpg"))
    
    let thumbnail = Thumbnail(path: "http://i.annihil.us/u/prod/marvel/i/mg/c/e0/535fecbbb9784", 
                              extension2: "jpg")
    
    let hero = HeroeData(id: 1011334, 
                         name: "3-D Man",
